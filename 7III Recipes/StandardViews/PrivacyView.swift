    ...
    var body: some View {
        List {
            Text("""
                ...
                Contact Information:
                If you have any questions or concerns regarding the privacy practices of the 7III Recipes app, please contact us at [hi@project7iii.com](hi@project7iii.com).
